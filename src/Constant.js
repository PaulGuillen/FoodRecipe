...
export const recipeList = [
  {
    ...
    color: "#006A4E",
    description:
      "La Ensalada Rusa es una de las ensaladas más consumidas en el mundo y muchas de sus versiones obedecen a las costumbres de cada país en donde es consumida. En nuestro país, se caracteriza por llevar beterraga (remolacha), rica en vitaminas A y C. ¿Te animas a prepararla?",
    steps: [
      "Primero hierve las papas (patatas), las betarragas y las zanahorias, todas sin pelar. Las zanahorias normalmente necesitan más tiempo.",
      "Cuando estén hervidas, retira las verduras, déjalas enfriar y pélalas.",
      "Mientras tanto pon en otra olla las vainitas y los guisantes y hiérvelos sin pasarte de tiempo",
      "En otra olla hierve los huevos.",
      "Cuando tengas todo hervido, pica las papas, las beterragas y las zanahorias en dados.",
      "Agrega las vainitas y los guisantes. Añade mayonesa, sal y pimienta al gusto. Remuévelo todo",
      "Para servir pon una hoja de lechuga y en el centro un poco de ensalada. Buen provecho."
    ],
  },
  {
    id: "02",
